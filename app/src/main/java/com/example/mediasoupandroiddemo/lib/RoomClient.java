...
import static com.example.mediasoupandroiddemo.lib.JsonUtils.toJsonObject;
...
import com.example.mediasoupandroiddemo.lib.model.Peer;
...
public class RoomClient extends RoomMessageHandler {
  ...
  public RoomClient(
    ...
    this(context, roomStore, roomId, peerId, displayName, null, false, false, null);
  }
  ...
  public RoomClient(
      ...
      String displayName,
      RoomOptions options) {
    this(context, roomStore, roomId, peerId, displayName, null, false, false, options);
  }
