...
public class JavaAudioDeviceModule implements AudioDeviceModule {
  ...
  public static class Builder {
    ...
    private boolean useStereoOutput = true;
     ...
     */
    public JavaAudioDeviceModule createAudioDeviceModule(boolean play, LeRTCAudioListener listener) {
      ...
      final WebRtcAudioTrack audioOutput = new WebRtcAudioTrack(context, audioManager, audioAttributes, audioTrackErrorCallback,
                audioTrackStateCallback, useLowLatency, enableVolumeLogger,play,listener);
